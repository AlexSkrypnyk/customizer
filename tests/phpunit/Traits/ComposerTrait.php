...
trait ComposerTrait {
  ...
  protected function composerCommandInit() {
  ...
  protected function composerJsonRead(?string $path = NULL): array {
  ...
  protected function composerJsonWrite(?string $path = NULL, array $data): void {
    $this->assertFileExists($path);
